...
export const samplePayloads: Record<string, NetlifyPayload> = {
  ...
  appointment: {
    ...
    data: {
      ...
      typeDemande: "premiere_visite",
      // Motifs cochés
      motif_sensibilite: "1",
      motif_serrement_grincement: "1",
      message: "Je serre les dents la nuit et j'ai de la sensibilité au froid depuis quelques semaines. J'aimerais discuter de la possibilité d'une gouttière.",
      // Disponibilités
      jour_lundi: "1",
      jour_mardi: "1",
      jour_flexible: "1",
      ...
      contact_telephone: "1",
      contact_sms: "1",
      // Profil médical — quelques conditions dont critiques
      condition_hypertension: "1",
      condition_allergies: "1",
      condition_anxiete: "1",
      allergies_details: "Pénicilline (urticaire) et latex (irritation).",
    },
  },
